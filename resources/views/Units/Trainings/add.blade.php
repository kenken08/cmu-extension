                ...
                {{Form::token()}}
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <img id="training_photo" src="" alt="" width="250px" height="100px">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea role="text" name="description" class="form-control" placeholder="Write projects description here..." style="height:100px;"></textarea>
                                </div>
                            </div>
                        </div>
                    </fieldset>
...
@section('scripts')
    ...
    $(document).ready(function() {
        ...
        result();
        $("#noofdays,#hrs,#noofparticipantstrained").on("keydown keyup", function() {
            result();
        });
    });
    function result(){
